class User < ApplicationRecord
  ...
  validates :last_name_kana, format: { with: /\A[\p{katakana}ー－]+\z/, message: '全角カタカナのみを使用してください' }
  validates :first_name_kana, format: { with: /\A[\p{katakana}ー－]+\z/, message: '全角カタカナのみを使用してください'}
